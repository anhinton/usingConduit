...
and 'RCurl'. The 'devtools' package is required to
install conduit directly from github. The 'Rgraphviz' and
'gridGraphviz' packages are required to run the modules in this
example.
