...
The component's output can be found in 
[modules/createGraph](modules/createGraph):  
...
The component's output can be found in 
[modules/layoutGraph](modules/layoutGraph):  
...
The resulting XML file can be found in 
...
The resulting XML files can be found in [exportPipeline/graphExport](exportPipeline/graphExport):
