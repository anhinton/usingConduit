...
The R scripts for our example are as follows: 
  ...
  + [nameSuburbs.R](aucklandRents/scripts/nameSuburbs.R):

```{r nameSuburbsScript, echo=FALSE}
cat(readLines("aucklandRents/scripts/nameSuburbs.R"), sep="\n")
```
    
  + [chooseSuburbs.R](aucklandRents/scripts/chooseSuburbs.R):

```{r chooseSuburbsScript, echo=FALSE}
cat(readLines("aucklandRents/scripts/chooseSuburbs.R"), sep="\n")
```
    
  + [boxplotBySuburb.R](aucklandRents/scripts/boxplotBySuburb.R):

```{r boxplotBySuburbScript, echo=FALSE}
cat(readLines("aucklandRents/scripts/boxplotBySuburb.R"), sep="\n")
```
